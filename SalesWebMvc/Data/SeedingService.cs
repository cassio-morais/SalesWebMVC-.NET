...
namespace SalesWebMvc.Data
{
    ...
    {
        private readonly SalesWebMvcContext _context; // registrando dependencia com db context
        ...
        public void Seed()
        {
            ...
            {
                return; // Banco de dados já contém dados
            }
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // add vários objetos ao bd ao mesmo tempo
